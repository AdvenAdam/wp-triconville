...
<div id="header__product"
     class="flex flex-row bg-gray-100"> </div>


<section id="header__banner"
         class="banner relative"></section>

<section class="filter__product flex justify-center flex-col items-center my-8 p-8">
    <h3 id="title__page"
        class="uppercase mt-8 mb-8">EXPLORE OUR OUTDOOR </h3>
...
<section class="list__product">
    <div id="list__product"
         class="container mx-auto grid gap-4 grid-cols-3"></div>
</section>
