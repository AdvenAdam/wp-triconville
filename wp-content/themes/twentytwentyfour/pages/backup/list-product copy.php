...
<section class="filter__product flex justify-center flex-col items-center my-8 p-8">
    ...
    <div class="relative inline-block w-64">
        <button id="dropdownButton"
            ...
            All Types
            <svg class="w-5 h-5 float-right mt-1"
...
<div class="list-product container mx-auto"
     id="product__collections">
...
$(document).ready(function() {
    ...
    function loadAllProduct(page) {
        ...
        $.ajax({
            ...
            success: (res) => {
                let findCategory = category.find(o => o.product_list.includes(all_product[page]))
                let checkElement = $(`#cat-${res.slug}`)
