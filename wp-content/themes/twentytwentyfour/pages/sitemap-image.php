...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
    ...
    <url>
        <loc><?= get_base_link(); ?>products/</loc>
    </url>
    <!-- NOTE List Of Product - Category -->
    <?php 
        foreach ($categoryProducts as $category) {
            echo "<url>\n";
            echo "<loc>" . get_base_link() . "products/" . $category['slug'] . "/</loc>\n";
                echo "<image:image>\n";
    ...
    <url>
        <loc><?= get_base_link(); ?>collections/</loc>
        <?php 
    ...
    <?php 
        foreach ($collections as $collection) {
            ...
            echo "<url>\n";
            echo "<loc>" . get_base_link() . "collections/" . $collectionName . "/</loc>\n";
    ...
    <?php 
        foreach ($products as $product) {
            ...
            echo "<url>\n";
            echo "<loc>" . get_base_link() . "product-detail/{$product}/</loc>\n";
                echo "<image:image>\n";
    ...
    <?php 
        ...
        ?>
    <url>
        <loc><?= get_base_link(); ?>moods/</loc>
    </url>
    <!-- NOTE List Of Mood -->
    <?php 
        foreach ($moods as $mood) {
            echo "<url>\n";
            echo "<loc>" . get_base_link() . "moods/" . $mood['slug'] . "/</loc>\n";
                echo "<image:image>\n";
    ...
    <url>
        <loc><?= get_base_link(); ?>materials/</loc>
        <?php 
    ...
    <url>
        <loc><?= get_base_link(); ?>inspiration/</loc>
        <?php 
    ...
    <url>
        <loc><?= get_base_link(); ?>about-us/</loc>
        <image:image>
    ...
    <url>
        <loc><?= get_base_link(); ?>contact-us/</loc>
    </url>

    <url>
        <loc><?= get_base_link(); ?>find-a-store/</loc>
    </url>

    <url>
        <loc><?= get_base_link(); ?>request-catalog/</loc>
    </url>
